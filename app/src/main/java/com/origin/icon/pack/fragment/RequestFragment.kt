...
import com.origin.icon.pack.adapter.RequestsAdapter
import com.origin.icon.pack.bean.RequestsBean
...
// intent.putExtra(Intent.EXTRA_EMAIL, email)，结果将匹配不到任何应用
    ...
    private fun getMessage(): String{
        ...
        message.append("App Packname: ${Utils.getAppPackName(context!!)}")
